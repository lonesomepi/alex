...
if(is_admin()){
	...
	require_once plugin_dir_path(__FILE__) . 'admin/clas_people-metabox.php';
}
...
function ufclas_team_member_styles() {
	...
	wp_enqueue_style('ufclas-team-members-style');
	// Load the Internet Explorer 8 specific stylesheet.
	wp_enqueue_style( 'ufclas-team-members-style', get_template_directory_uri() . '/css/team-member-styles.css' );
}
